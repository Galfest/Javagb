//package com.gb.java.hw.hw4.v1.utils;
//
...
//    public static final String PLEASE_REPEAT = "Please, try again.";
//    private static final String PROMPT_ENTER = "Press enter to continue...";
//    private static final String WARN_WRONG_MENU_ITEM = "Uncorrected. "
//            + PLEASE_REPEAT;
//    private static final String ERR_NOT_INT = "Need Integer. " + PLEASE_REPEAT;
//    private static final String ERR_INT_MUST_BE_IN_RANGE = "Need Integer between %d to %d! "
//            + PLEASE_REPEAT;
//    private static final String ERR_INT_TOO_LOW = "Value must be less then %d! " + PLEASE_REPEAT;
//    private static final String ERR_INT_TOO_HIGH = "Value must be more then %d! " + PLEASE_REPEAT;
//    private static final String ERR_WRONG_DATE_FORMAT = "Need YYYY-MM-DD! "
//            + PLEASE_REPEAT;
