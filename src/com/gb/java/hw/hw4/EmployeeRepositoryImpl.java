...
import com.gb.java.hw.hw4.abstractions.EmployeeRepository;
...
;
public class EmployeeRepositoryImpl2 implements EmployeeRepository.EmployeeRepository1 {
    ...
    @Override
    public Collection<EmployeeRepository.EmployeeRepository1.NamePhoneTuple> getPhonesByName(String namePattern){
